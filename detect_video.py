...
Banner = ["<img src='download.png' alt='Trulli' width='1400' height='334'>\n"]
...
Logo = ["<img src='Logo.png' alt='Logo' width='446' height='452'>\n"]
...
def detect_video(opt, save_img=False):
    ...
    if device.type == 'mps':
        half = False  # MPS does not support half precision
    else:
